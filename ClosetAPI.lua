...
getAllPeripherals = function(silent) --Silent makes it not return the full table(Non-Silent by default)
    ...
    for i = 1,#cp do
        ...
        elseif curtype == "tile_blockcapacitorbank_name"    or string.find(curtype,"tile_thermalexpansion_cell") == 1   or type(string.find(curtype,"EnergyCube")) == "number"   or curtype == "draconic_rf_storage"    or curtype == "thermalexpansion:storage_cell" then
